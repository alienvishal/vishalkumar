	...
	private void initialize() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				boolean status=AccountDatabase1.validate(name, password);
				if(status){
					...
					JOptionPane.showMessageDialog(null,AccountantLogin.this, "Invaild UserName or Password !!!",JOptionPane.ERROR_MESSAGE);
					textField.setText("");
